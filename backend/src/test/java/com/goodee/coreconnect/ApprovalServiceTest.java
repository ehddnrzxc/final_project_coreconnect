...
public class ApprovalServiceTest {
    ...
    void createDocument_Success_WithFiles() throws IOException {
        ...
        requestDTO.setApprovalIds(List.of(approver1.getId(), approver2.getId()));
    ...
    void createDocument_Success_NoFiles() throws IOException {
        ...
        requestDTO.setDocumentContent("내용입니다.");
        requestDTO.setApprovalIds(List.of(approver1.getId()));
    ...
    void createDocument_Fail_ApproverNotFound() {
        ...
        DocumentCreateRequestDTO requestDTO = new DocumentCreateRequestDTO();
        requestDTO.setTemplateId(template.getId());
        requestDTO.setApprovalIds(List.of(99999)); // 존재하지 않는 결재자 ID
    ...
    void getMyDrafts_Success() {
        ...
        // Act (When)
        List<DocumentSimpleResponseDTO> drafts = approvalService.getMyDrafts(drafter.getEmail());
  ...
  void setUp() {
    ...
    // User.createUser(password, name, role, email, phone, department)
    // Department가 필수지만, ApprovalService 테스트에는 불필요하므로 null 전달
    drafter = User.createUser("password123", "기안자", Role.USER, "drafter@test.com", "010-1111-1111", null);
    approver1 = User.createUser("password123", "결재자1", Role.USER, "approver1@test.com", "010-2222-2222", null);
    approver2 = User.createUser("password123", "결재자2", Role.USER, "approver2@test.com", "010-3333-3333", null);
  ...
  void getDocumentDetail_Fail_NoPermission() {
    // Arrange
    User otherUser = User.createUser("pass123", "외부인", Role.USER, "other@test.com", "010-4444-4444", null);
    userRepository.save(otherUser);
