...
        <NavLink to="/e-approval/pending" className="sub-nav-item">결재 대기 문서</NavLink>
        <NavLink to="/e-approval/received" className="sub-nav-item">결재 수신 문서</NavLink>
      </div>

      {/* 메뉴 그룹 3: 기안 문서함 */}
      <div className="sub-nav-group">
        <h4 className="sub-nav-title">기안 문서함</h4>
        <NavLink to="/e-approval/drafts" className="sub-nav-item">기안 문서함</NavLink>
        <NavLink to="/e-approval/completed" className="sub-nav-item">결재 완료함</NavLink>
        <NavLink to="/e-approval/rejected" className="sub-nav-item">반려 문서함</NavLink>
      </div>
      
...
        <Outlet /> {/* 여기가 ApprovalHomePage, ApprovalWritePage 등으로 교체됨 */}
      </main>
    </div>
  );
};
